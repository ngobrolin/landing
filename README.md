...
### Option C: Use auto sub from YouTube

Turns out auto sub generated by YouTube good enough for summarization and find moments. Run `yt-dlp` with `--write-automatic-subs --sub-format srt --sub-langs id`
