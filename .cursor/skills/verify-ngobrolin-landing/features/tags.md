...
- **Tag formatting** — tags are lowercase slugs (e.g., `typescript`, `ai`, `astro`), displayed with sentence case plus specific overrides (e.g., `ai` → `AI`, `nextjs` → `Next.js`)
...
3. **Direct URLs:**
   ...
   - `/tags/react` — episodes about React
