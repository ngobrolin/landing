...
This directory maps the user-facing features of the Ngobrolin WEB site. Each file describes one feature area from the user's perspective.
...
- Brief description
- Sub-features (what the feature includes)
- How to get to it (user perspective)
- Driving it with the verification harness
